...
def write_experiment_config(
    ...
    This uses the same layout as the FFT script:
        1. Executable Line
        2. Dataset
        3. Feature Settings
        4. Training Settings
    ...
    with open(config_path, "w", encoding="utf-8") as f:
        ...
        f.write("----------------\n")
        f.write("feature_family: STFT\n")
        f.write("feature_type: log-magnitude STFT / spectrogram\n")
        ...
        f.write(f"cache_dir: {cache_text}\n\n")

        f.write("Training Settings\n")
        f.write("-----------------\n")
        f.write("model: SmallSTFT2DCNN\n")
        ...
        f.write("saved_model: best_stft_2dcnn.pt\n")
...
def main():
    ...
    if args.data_root is None:
        raise ValueError("Missing data_root. Set it in YAML or pass --data-root.")
